...
let buttonMessage = {
image: {url: `https://telegra.ph/file/f0dd0717cb9026245f8da.jpg`},
jpegThumbnail: log0,
caption: teks,
footer: `${botname}`,
buttons: buttons,
...
mediaType:1,
mediaUrl: 'https://youtube.com/@rielbotzoffc2764',
sourceUrl: "https://youtube.com/@rielbotzoffc2764"
}}
}
...
case 'tiktoknowm':
			...
			case 'tt':
				...
				let nih = ` 𝘕𝘪𝘩 𝘒𝘢𝘬 𝘔𝘢𝘥𝘦 𝘉𝘺 ${author} 𝘑𝘢𝘯𝘨𝘢𝘯 𝘓𝘶𝘱𝘢 𝘚𝘶𝘴𝘤𝘳𝘪𝘣𝘦 https://youtube.com/@rielbotzoffc2764`
				let buttons = [
